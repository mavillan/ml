...
\ShortHeadings{Identificación Facial con pocas muestras por clase}{Villanueva}
\firstpageno{1}

\begin{document}

\title{Identificación facial con pocas muestras por clase}

\author{\name Martín Villanueva  \email mavillan@alumnos.inf.utfsm.cl \\
       \addr Departamento de Informática\\
